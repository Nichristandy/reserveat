    ...
    <div className="home-main">
      ...
      <section className="home-body">
        <div>
          ...
          <a href="/allmenu">See More </a>
        </div>

        <span className="fir-sec">
          <a
            href="/reservasi"
            className="first bg-cover bg-center fir-sec bg-[url('/SeemoreAssets/burger_rio.jpg')] "
          >
            Rio Burger
          </a>
          <div className="second">
            <a className="bg-cover bg-center fir-sec bg-[url('/SeemoreAssets/pizza_udin.jpg')]">
              Pizza Udin
            </a>
            <a className="bg-cover bg-center fir-sec bg-[url('/SeemoreAssets/pizza_udin.jpg')]">
              Pizza Udin
